...
bar_plot(
  *sort_freq_dist(ham_headers_received_len_freq_dist),
  'Number of hops',
  'Number of emails',
  'Plot of the number of servers through which ham emails hopped',
...
bar_plot(
  *sort_freq_dist(spam_headers_received_len_freq_dist),
  'Number of hops',
  'Number of emails',
  'Plot of the number of servers through which spam emails hopped',
...
bar_plot(
  *list(zip(*spam_hop_countries_uniq_freq_dist.most_common(10))),
  'Number of unique countries hopped',
  'Number of emails',
  'Plot of the number of unique countries through which spam emails hopped',
